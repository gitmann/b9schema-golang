...
var rootJSONTests = []fixtures.TestCase{
	...
	},
	{
		...
		Value:        fromJSON([]byte(`{}`)),
		RefStrings:   []string{"RootID.!{}! ERROR:empty map not supported"},
		DerefStrings: []string{"RootID.!{}! ERROR:empty map not supported"},
	},
	{
		Name:  "json-object",
...
var typeTests = []fixtures.TestCase{
	...
	},
	{
		...
		RefStrings: []string{
			...
			`TypeRefID.CompoundTypes:{}.!Map:{}! ERROR:map key type must be string`,
		...
		DerefStrings: []string{
			...
			`RootID.{}.!Map:{}! ERROR:map key type must be string`,
